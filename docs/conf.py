#
# pyospackage-nourshawk documentation build configuration file
#
import os
import sys
...
# built documents.
try:
    version = importlib.metadata.version("pyospackage_nourshawk")
...
htmlhelp_basename = "pyospackage-nourshawk_doc"
